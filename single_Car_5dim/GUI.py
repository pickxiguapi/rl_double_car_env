...
class GUI(object):
    ...
    def draw_car(self, position, lane, car_id):
        # 根据车的位置绘制车
        if car_id == 0:
            car_image = pygame.image.load("../pic/car3_black.png").convert_alpha()
        else:
            car_image = pygame.image.load("../pic/car3_green.png").convert_alpha()
